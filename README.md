•	 Built a Spring Boot application for vehicle management with JPA repositories, enabling efficient CRUD operations on vehicle entities including ID, name, price, model, and colour.
